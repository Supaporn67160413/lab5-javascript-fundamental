...
//let: ใช้สำหรับตัวแปรที่เปลี่ยนค่าได้
//const:ใช้สำหรับตัวแปรที่เปลี่ยนค่าไม่ได้
//var: ใช้ตัวแปรไปก่อน ประกาศทีหลัง (หลีกเลี่ยง)
...
//เรียกตัวเองจนกว่าเลขต่อไปจะเป็น 0
...
function createUser(firstName, lastName, age) {
  return {
    firstName, //shorthard for firstName --สำคัญมาก
    lastName,
    age,
...
const calculator = {
  ...
  subtract: (a, b) => a - b,
  multiply: (a, b) => a * b,
  divide: (a, b) => (b === 0 ? "Connot divide by zero" : a / b),
